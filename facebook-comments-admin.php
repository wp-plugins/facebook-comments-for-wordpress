<?php
	...
	if ($_POST['fbComments_update'] == 'true') {
		...
		$fbComments_settings['fbComments_appSecret'] = (!empty($_POST['fbComments_appSecret'])) ? esc_html(stripslashes($_POST['fbComments_appSecret'])) : null;
...
<div class="wrap">
	...
	<?php
		...
		} elseif (empty($fbComments_settings['fbComments_appSecret'])) {
			echo '<div class="error"><p><strong>' . __('Combined comment counts will not work properly until you set a valid application secret.') . '</strong></p></div>';
	...
	<h2><?php _e('If you need help, please refer to the <a href="http://grahamswan.com/facebook-comments/">official FAQ</a>.'); ?></h2>
