...
?>
	...
	<div id="poststuff" class="postbox">
		...
		<div class="inside">
			...
			<p><input type="checkbox" id="fbComments_fbCommentCount" name="fbComments[fbCommentCount]" value="1" <?php checked($fbc_options['fbCommentCount'], 1 ); ?>>
				<label for="fbComments_fbCommentCount"> <?php _e('<em>*just added*</em> Enable native facebook comment count (<em>does nothing unless "v2 only" is selected</em>).'); ?>
				</label>
			</p>
	...
	<div id="poststuff" class="postbox">
		<h3><?php _e('<em>*just added*</em> v2 Comment Count Style'); ?></h3>	
		<div class="inside">
	...
	<div id="poststuff" class="postbox">
		<h3><?php _e('<em>*just added*</em> Like Button Settings'); ?></h3>
